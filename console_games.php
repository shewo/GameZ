...
<nav class="navbar navbar-expand-lg navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"> <a class="nav-link active" href="console_games.php">Console Games</a> </li>
    </ul>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="d-block w-100 rounded" src="images/Senuas-Saga-Hellblade-II-Enhanced-Edition-scaled.png" alt="Slide 1" height="600" />
        ...
        <div class="carousel-item">
          <img class="d-block w-100 rounded" src="images/spiderman21.jpeg" alt="Slide 2" height="600" />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img class="d-block w-100 rounded" src="images/plaugetale.jpeg" alt="Slide 3" height="600" />
          <div class="carousel-caption d-none d-md-block">
